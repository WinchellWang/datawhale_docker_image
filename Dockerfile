...
RUN /bin/bash -c "source /root/.bashrc && source activate TorchText && python -m spacy download zh_core_web_sm && python -m spacy download en_core_web_sm && source deactivate"
